...
let average132 = average132Temp.toFixed(2); // gets rid of all extra decimals and leaves 2 decimal spaces
...
//} END OF FUNCTION..
    ...
    return null// the error if there is one will now not mean anything...? new concept.
}
//getLearnerData()
